...
final class Repository_Registry {
	...
	private function defaults() {
		$items = array(
			...
			array( 'name' => 'Modern Catholic – Parish Events', 'repository' => 'twitchd8/modern-catholic-plugin-parish-events', 'type' => 'plugin', 'slug' => 'modern-catholic-plugin-parish-events', 'entrypoint' => 'modern-catholic-parish-events.php' ),
